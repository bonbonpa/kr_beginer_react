...
## TOC  
 ...
 - [Start React](#start-react)
   * [1. Intro React](#1-intro-react)
     + [install react-app](#install-react-app)
     + [create project](#create-project)
     + [And Then Start project](#and-then-start-project)
   * [2. JSX Syntax](#2-jsx-syntax)
   * [3. Style and Expression JSX](#3-style-and-expression-jsx)
   * [4. Create Component](#4-create-component)
     + [Create file for Component](#create-file-for-component)
       - [Header.js](#headerjs)
       - [Content.js](#contentjs)
       - [Footer.js](#footerjs)
     + [And import Component to App.js](#and-import-component-to-appjs)
   * [5. Props](#5-props)
     + [Adding properties to components -> App.js](#adding-properties-to-components----appjs)
     + [And Show value of properties -> Contents.js](#and-show-value-of-properties----contentsjs)
   * [6. State](#6-state)
     + [Add state in file -> Content.js](#add-state-in-file----contentjs)
   * [7. Event](#7-event)
     + [Add Event -> App.js](#add-event----appjs)
   * [8. Event OnChange](#8-event-onchange)
     + [Add Event onChange for typing -> App.js](#add-event-onchange-for-typing----appjs)
   * [9. Router](#9-router)
     + [Clear App.js for Router](#clear-appjs-for-router)
     + [Install React Router](#install-react-router)
     + [move import component from App.js to index.js](#move-import-component-from-appjs-to-indexjs)
     + [Add Home path to Content.js , Header.js , Footer.js](#add-home-path-to-contentjs---headerjs---footerjs)
 - [Start Redux](#start-redux)
   * [1. Redux Concept](#1-redux-concept)
